...
<!--  
	관리자 > 부서관리 > 직원안내도 > 부서추가/수정 > 날씨/미세먼지 배치도 HTML
...
<div id="oneArrangeDiv_${arrangeInfo.arrangeCode}" class="arrangeDiv" style="position:absolute;text-align:center;z-index:90;">
	...
	<!--날씨, 미세먼지 정보-->
	<div onmouseout="hideSetupBtnDiv();" onmouseover="showSetupBtnDiv('${arrangeInfo.arrangeCode}');" class="info_box weather_info_area">
		<div class="info_area weather">
			<strong class="title">제주시</strong>
			<div class="info_view">
				<div class="icon"> 
					<em><img src="/images/kiosk/icon/weathers/weather_icon_02.png" alt="구름조금"></em>
				</div>
				<div class="text"> 
					<strong><span>23</span><span>℃</span></strong> 
				</div>
			</div>
		</div>
		<div class="info_area air">
			...
			<div class="info_view">
				<div class="text"><strong>27 <span>㎍/㎥</span></strong></div>
				<div class="icon"><em><img src="/images/kiosk/icon/weathers/fineDust_icon_01.png" alt="좋음"> 좋음</em></div>
			</div>
		</div>
	</div>
	<!--//날씨, 미세먼지 정보-->
