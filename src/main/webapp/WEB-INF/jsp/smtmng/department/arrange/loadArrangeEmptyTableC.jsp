...
<div id="oneArrangeDiv_${arrangeInfo.arrangeCode}" class="arrangeDiv" style="position:absolute;text-align:center;z-index:90;">
	...
	<div onmouseout="hideSetupBtnDiv();" onmouseover="showSetupBtnDiv('${arrangeInfo.arrangeCode}');" id="setupButtonDiv_${arrangeInfo.arrangeCode}" class="setupButtonDiv" style="display:none;position:absolute;margin-top:-30px;text-align:center;width:${widthBtn}px;padding:0;z-index:90;opacity:0.9;padding-bottom:6px;">
	...
	<div class="org_section ${arrangeInfo.bgColor}" style="width: ${width}px"> 
				...
				<div class="org_info ${deskInfo_col_row.bgColor}" <c:if test="${deskInfo_col_row.showFlag == 'N'}">style="background:#ccc;"</c:if>>
					...
					<c:choose>
						...
						<c:otherwise>
							...
							<div class="text <c:if test="${deskInfo_col_row.showFlag != 'N'}">noInfo</c:if>" <c:if test="${deskInfo_col_row.showFlag == 'N'}">style="background:#ccc;"</c:if>>
