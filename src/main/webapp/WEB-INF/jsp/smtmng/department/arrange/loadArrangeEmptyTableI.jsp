...
<!--  
	관리자 > 부서관리 > 직원안내도 > 부서추가/수정 > 청사안내버튼 배치도 HTML
...
<div id="oneArrangeDiv_${arrangeInfo.arrangeCode}" class="arrangeDiv" style="position:absolute;text-align:center;z-index:90;">
	...
	<!--청사안내 버튼-->
	<div onmouseout="hideSetupBtnDiv();" onmouseover="showSetupBtnDiv('${arrangeInfo.arrangeCode}');" class="jejusiMap_button">
		<button type="button" class="jejusiMap">청사안내보기</button>
	</div>
	<!-- //청사안내버튼 -->
