	...
	<div onmouseout="hideSetupBtnDiv();" onmouseover="showSetupBtnDiv('${arrangeInfo.arrangeCode}');" class="daily_info_area">
		...
		<div class="main_video">               
			...
			<div id="player" style="width:480px; height:270px;">
				<iframe width="480" height="270" src="<c:out value="${utubeMap.utubeUrl}"/>?controls=0" frameborder="0" allow="accelerometer; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			</div> 
		</div>
		<!--//메인 영상-->
	</div>
