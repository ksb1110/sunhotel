...
<!--  
	관리자 > 부서관리 > 직원안내도 > 부서추가/수정 > 홍보이미지(일반) 배치도 HTML
...
<div id="oneArrangeDiv_${arrangeInfo.arrangeCode}" class="arrangeDiv" style="position:absolute;text-align:center;z-index:90;">
	...
	<!-- 홍보이미지 -->
	<div onmouseout="hideSetupBtnDiv();" onmouseover="showSetupBtnDiv('${arrangeInfo.arrangeCode}');" class="alimi_area sliding_banner size400" style="width:400px;height:400px;">
