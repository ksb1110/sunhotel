...
<title>키워드통계 - 통계 - 제주시 스마트청사안내 관리자페이지</title>
...
function fn_Search(pageIndex){
    ...
    document.frm.action = "<c:url value='/smtmng/kioskstat/keywordList.ez'/>";
    document.frm.submit();
}
</script>
...
<div id="wrap">
	...
	<jsp:include page="/smtmng/header.ez" flush="false">
		...
		<jsp:param name="admin_menu2" value="keywordList"/>
	</jsp:include>
	
    <main id="main">
		<section class="contents-wrap">
            <h2 class="title1">키워드통계</h2>     
              
		    <div class="item-col3-wrapper">
		    
                <!-- //${searchVO.pageIndex}//${searchVO.sDttm}//${searchVO.eDttm}// -->
							...
							<tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="border:0;"  >
                                        ...
                                        <button type="button" class="btn" onclick="document.location.href='<c:url value='/smtmng/kioskstat/keywordList.ez'/>';">전체</button>
                                    </td>                                   
                                </tr>
		    	...
		    	<div class="table-wrapper">
                     ...
                     <table class="table center" style="width:600px;" >
                        <colgroup>
