...
<title>코드등록 - 코드관리 - 시스템관리 - 제주시 스마트청사안내 관리자페이지</title>
...
function insertCode() {
	...
	if(confirm("<spring:message code='confirm.ins'/>")) {
		...
		$.ajax({
			...
			processData:false,
			async:false,
			url:"<c:url value='/smtmng/system/code/codeInsert.ezax'/>",
			data:parameters ,
...
<div class="win-popup">
    ...
    <form name="insert_form" id="insert_form" method="post" onsubmit="insertCode();return false;">
        ...
        <table class="table-row th-left">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="width100" name="code">
                    </td>
                    <th>
                        <div class="necessary-area">
                            <img class="necessary" src="${pageContext.request.contextPath}/images/admin/icon/temp/red_check.png" alt="체크">
                ...
                <tr>
                    <th>추가정보1</th>
                    <td colspan="3">
                        <input type="text" class="width100" name="add1">
                    </td>
                </tr>
                <tr>
                    <th>추가정보2</th>
                    <td colspan="3">
                        <input type="text" class="width100" name="add2">
                    </td>
                </tr>
                <tr>
                    <th>표시순서</th>
