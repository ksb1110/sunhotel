...
<title>등록 - 접근IP설정관리 - 시스템관리 - 제주시 스마트청사안내 관리자페이지</title>
...
function insertIp() {
	...
	if(confirm("<spring:message code='confirm.ins'/>")){
		...
		$.ajax({
			...
			processData:false,
			async:false,
			url:"<c:url value='/smtmng/system/ip/ipInsert.ezax'/>",
			data:parameters ,
...
<div class="win-popup">
    ...
    <form name="insert_form" id="insert_form" method="post" autocomplete="off" onsubmit="insertIp();return false;">
        ...
        <table class="table-row th-left">
            ...
            <tbody>
                <tr>
                    <th>허용구분</th>
                    <td colspan="3">
                        <label><input type="radio" name="limitGubun" value="A" checked> 허용아이피</label>
                        &nbsp;&nbsp;&nbsp;
                        <label><input type="radio" name="limitGubun" value="B"> 차단아이피</label>
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td colspan="3">
                        <label><input type="radio" name="rangeGubun" value="A" onclick="changeRangeGubun();" checked> 단일아이피</label>
                        &nbsp;&nbsp;&nbsp;
                        <label><input type="radio" name="rangeGubun" value="B" onclick="changeRangeGubun();"> 아이피대역</label>
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td colspan="3">                    	
                        <input type="text" class="width10" name="startIp1" maxlength="3" style="text-align:center;">
                        .                        
                        <input type="text" class="width10" name="startIp2" maxlength="3" style="text-align:center;">
                        .
                        <input type="text" class="width10" name="startIp3" maxlength="3" style="text-align:center;">
                        .
                        <input type="text" class="width10" name="startIp4" maxlength="3" style="text-align:center;">
                        
                        <span id="endIpSpan" style="display:none;">
                        
	                        &nbsp;&nbsp;&nbsp;~&nbsp;&nbsp;&nbsp;
	                        
	                        <input type="text" class="width10" name="endIp1" maxlength="3" style="text-align:center;">
	                        .
	                        <input type="text" class="width10" name="endIp2" maxlength="3" style="text-align:center;">
	                        .
	                        <input type="text" class="width10" name="endIp3" maxlength="3" style="text-align:center;">
	                        .
	                        <input type="text" class="width10" name="endIp4" maxlength="3" style="text-align:center;">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <label><input type="radio" name="periodFlag" value="Y" onclick="changePeriodFlag();" checked> 기간으로 설정</label>
                        &nbsp;&nbsp;&nbsp;
                        <label><input type="radio" name="periodFlag" value="N" onclick="changePeriodFlag();"> 제한기간 없음</label>
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td colspan="3">
                    	<span class="date-wrap">
                        	<input type="text" class="width100 datepicker" name="startDate" value="" readonly>
                        </span>
                        
                         &nbsp;&nbsp;&nbsp;~&nbsp;&nbsp;&nbsp;
                         
                    	<span class="date-wrap">
                        	<input type="text" class="width100 datepicker" name="endDate" value="" readonly>
                        </span>
                    </td>
            	</tr>
                <tr>
                    <th>적용여부</th>
                    <td colspan="3">
                        <label><input type="radio" name="useFlag" value="Y" checked> 적용</label>
                        &nbsp;&nbsp;&nbsp;
                        <label><input type="radio" name="useFlag" value="N"> 미적용</label>
                    </td>
                </tr>
            </tbody>
        </table>
